...
%While a 40$\%$ acceptance has been found to provide the best compromise between the
%number of accepted trajectories and decorrelation of the
%trajectories from one another, 
%we find that a lower acceptance
%ratio provides quicker decorrelation from the initial constrained
%trajectory, especially in more complex systems such as enzymes.
%------------------------------------------------------------------------------ 
