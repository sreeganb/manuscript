...
% We are somewhat at loss how to respond to this criticism,
% which seems to contradict Reviewer B's statements,
% ``I have to stress that the paper discusses complex material and still
% it is in general clearly written. It can be accessible for readers who
% are less familiar with RPA or many-body theory.''
...
% REPLY
For the \textit{pv}ADA enzyme the two steps in the reaction are the nucleophilic attack 
of the OH$^{-}$ on the C6 atom and the transfer of the proton from the OH$^{-}$ 
to the N6 atom with the formation of NH$_3$. We are including the time series of the 
N6-H1 distances in the supporting information which would show the sequence of events 
along a typical TPS trajectory for this reaction. 
