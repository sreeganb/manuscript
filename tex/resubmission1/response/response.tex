...
in regions where the free energy curve has a large slope the trajectories more often tend to sample 
configurations that are outside the window with acceptance percentages $\leq 10$. 
...
is negligible as a function of the number of sampled trajectories to make sure that we have achieved 
...
We have provided a diff.pdf file which highlights all the changes that were made to 
the manuscript after we received the reviewer's comments. 
\end{document}
