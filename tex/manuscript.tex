...
The TPS ensemble which is used to obtain a unique statistical definition for the reaction coordinate
and transition state of a reaction consists of so called reactive trajectories which 
link the stable reactant and product states. In this Monte-Carlo procedure in the trajecotry space
...
%------------------------------------------------------------------------------ 
\subsection{Human MethionineAdenosyltransferase 2A}
%------------------------------------------------------------------------------ 
The SN2 reaction catalyzed by the human Mat2a enzyme leads to the production of 
S-Adenosylmethionine compound which is part of the ATP cycle \cite{Niland21Biochem60p791}
\begin{figure}[ht!]
\includegraphics[scale=0.5]{figures/comm-80-mat2a.pdf}
\end{figure}
