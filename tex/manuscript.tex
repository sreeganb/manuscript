...
Straightforward MD simulations are not employed in these cases because 
trajectories that take the system from reactant state to product state through
a transition state are rare and would take long time 

Ergodic sampling of the phase space within straighforward MD simulations 
is often difficult to achieve with the presence of energy barriers. 
To overcome such barriers enhanced sampling techniques 
have been developed over the years such as 
...
milestoning, \cite{Faradjian04JChemPhys120p10880} etc. These methods rely on applying bias
potentials for the system to overcome energy barriers and hence 
require the knowledge of the reaction coordinates.  
...
referred to as reactants and products.

TPS focuses on transition paths and not on stable states which introduces 
biases in the sampling of equilibrium distribution of the reaction coordinate. \cite{Dellago09AdvCompSimAppp167}

TPS based free energy simulations have been attempted previously by 
Brotzakis et al., \cite{Brotzakis19JChemPhys151p174111}

In this work we will focus on the implementation and application of the 
free energy based calculations within the TPS method on two enzymatic reactions: 
...
plasmodium vivax adenosine deaminase \cite{Luo07JAmChemSoc129p8008,Ho09Biochemistry48p9618}
%------------------------------------------------------------------------------ 
\section{Methods}
%------------------------------------------------------------------------------ 
