...
is an unbiased monte carlo method in the trajectory space which is used for the calculation 
of reaction coordinates and transition states of complex chemical reactions. 
TPS uses reactive trajectories which connect a reactant state to a product state and these 
trajectories are rare in molecular dynamics simulations because of the energy 
barriers separating the reactants and the products. To overcome these energy barriers and 
to obtain ergodic sampling several methods have been developed over the years such as 
umbrella sampling, \cite{Kastner11WileyInterdiscipRevComputMolSci1p932} metadynamics, \cite{Barducci11WileyInterdiscipRevComputMolSci1p826}
