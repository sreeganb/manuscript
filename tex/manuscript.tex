...
\begin{abstract}
  ...
  %introduced by 
  %Radhakrishnan et al. (Radhakrishnan, R.; Schlick, T., J. Chem. Phys. 2004, 121, 2436.) 
  ...
  enzyme and the plasmodium vivax adenosine deaminase enzyme to assess 
  ...
  the free energy barrier to be $16\;\text{Kcal}\;\text{mol}^{-1}$ which
  ...
  $23\;\text{Kcal}\;\text{mol}^{-1}$ and the calcualted free energy profile is
  similar to that predicted from experimental observations.
  We show that calculating free energies within TPS is lucrative as it is 
  bias free, accurate compared to experimental measurements 
...
dissociating C6$-$N6 (d$_{\text{NC}}$) bond distance. For the TPS simulaions 
we define the reactant state to have d$_{\text{NC}}$ being less than $1.7$ {\AA} 
and the product state to have the d$_{\text{OC}}$ less than $1.7$ {\AA}.
...
250 steps forawards and backwards using $1\;fs$ time steps
...
The order paratemer for the MAT2A system 
...
is used to guide the window based umbrella sampling simulations. 
To sample in a particular window $w$, a frame from this reactive 
...
\text{Kcal mol}^{-1}$ which is small Compared to typical enzyme catalyzed 
reactions.
\begin{figure}
...
The approaching O atom of the OH$^{-}$ anion is at a distance of $1.48$ {\AA}
...
The formation of the Meissenheimer complex like structure with 
d$_{\text{NC}}=1.60$ {\AA} and d$_{\text{OC}}=1.48$ {\AA} is observed.}
\label{fig:ada-trans}
\end{figure}
