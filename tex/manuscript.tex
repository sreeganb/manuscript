...
space of trajectories where the collected ensemble of 
reactive pathways are real dynamical trajectories generated without the 
application of any bias forces. Thus the TPS ensemble can be used to obtain 
...
catalysis reaction within TPS needs more attention. 
...
equilibrium probability distribution of the order parameter is missing. \cite{Dellago09AdvCompSimAppp167}
...
%------------------------------------------------------------------------------
We used the crystal structure of human MAT2A 
bound to methylthioadenosine and di-imido triphosphate (PNPNP)
(7L1A from the protein data bank (PDB)) reported by Niland 
et al. \cite{Niland21Biochem60p791} and the crystal structure of \textit{pv}ADA 
in complex with MT-coformycin (3EWC from the PDB) reported by Ho et 
al. \cite{Ho09Biochemistry48p9618} as the starting points of our two 
simulations. Molecular dynamics simulations within classical and hybrid 
quantum mechanics/molecular mechanics (QMMM) approximations were performed 
using the CHARMM program package and using the CHARMM 36 force 
field \cite{Brooks09JComputChem30p1545} for the MM part and the 
approximate PM3 semiempirical method \cite{Repasky02JComputChem23p1601} for the QM part.
...
%------------------------------------------------------------------------------ 
\subsection{Plasmodium vivax adenosine deaminase}
%------------------------------------------------------------------------------ 
