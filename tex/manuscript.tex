...
\caption{Equilibriated structure of MAT2A enzyme}
\end{figure}

The binding pocket image is shown for this enzyme here
% width: 3.330, height: 1.873
The TPS ensemble was used to analyze the reaction pathway for the S$_{\text{N}}2$
mechanism and a typical trajectory is provided here
\begin{figure}
\includegraphics[scale=1.0]{figures/mat2a-diff60.pdf}
...
\begin{figure}[ht!]
\includegraphics[scale=1.0]{figures/comm-60-mat2a.pdf}
\end{figure}
