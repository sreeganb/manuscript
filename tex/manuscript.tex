...
Molecular dynamics (MD) simulations are being 
...
enzyme activity, high throughput screening of millions of inhibitor 
molecues in drug discovery,   


This is quite useful in explaining 
the efficiency and rate of such reactions, developing 
inhibitors for various enzymes in pharmacology, de novo design of 
enzymatic activity.
MD simulations model chemical reactions by taking the system from a reactant state 
to a product state via a high energy transition state.
...
\includegraphics[scale=0.4]{figures/reac-sc-oc-167.png}
\caption{Trajectory 167}
\label{fig:minipage1}
\end{minipage}
\quad
\begin{minipage}[b]{0.45\linewidth}
\includegraphics[scale=0.8]{figures/den-fenergy-1.pdf}
